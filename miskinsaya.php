...
function check(){
	...
	$h[] = "Save-Data: on";
	$h[] = "User-Agent: Mozilla/5.0 (Linux; Android 6.0.1; Redmi Note 5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.80 Mobile Safari/537.36";
...
while($a<true){
	...
	$amount = @json_decode($c[1],true)['body']['amount'];
		...
		echo "Renew Cookie!\n";
		$cookie = curl("https://e.gift.id/u/83z15srs6ss46?fbclid=asdasdasd",true);
    	}
	echo "Checking ";
	$o+=1;
	if($o>2) $o=0;
